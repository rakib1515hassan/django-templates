...
var realTimeUsersChartInit = function realTimeUsersChartInit() {
  var $echartsRealTimeUsers = document.querySelector('.echart-real-time-users');
  var userCounterDom = document.getElementById('logged-in-users');
  ...
  if ($echartsRealTimeUsers) {
    ...
    var updateDataAndChart = function () {
      // Send request to the URL to get updated data
      fetch('/admin/live-data/')
        .then(response => response.json())
        .then(data => {
          // Update the displayed data
          userCounterDom.innerHTML = data.logged_in_users;
    ...
    // Set interval to update data and chart every 5 seconds
